<script>
	...
	let imageUrl = $state('https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Harvard_University_logo.svg/2560px-Harvard_University_logo.svg.png');
...
<Modal bind:open={formModal} size="lg" autoclose={false} class="w-full">
	<form class="flex flex-col space-y-6" action="#">
		...
		<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
			...
			<Label class="space-y-2">
				<span>Address</span>
				<Input type="text" name="password" placeholder="23, University Road, Akoka, Yaba, Lagos" required />
			</Label>
		</div>
